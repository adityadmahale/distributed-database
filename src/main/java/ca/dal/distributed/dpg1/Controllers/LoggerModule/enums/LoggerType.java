...
public enum LoggerType {
    ...
    public String getLoggerFile(){
        switch (this) { 
            case EVENT_LOGGER: return Constants.LOG_FILE_EVENT; 
            case QUERY_LOGGER: return Constants.LOG_FILE_QUERY; 
            case GENERAL_LOGGER: return Constants.LOG_FILE_GENERAL;  
